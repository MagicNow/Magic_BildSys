...
class ConfiguracaoEstaticaDataTable extends DataTable
{
    ...
    {
        $configuracaoEstaticas = ConfiguracaoEstatica::query();

        return $this->applyScopes($configuracaoEstaticas);
    }
