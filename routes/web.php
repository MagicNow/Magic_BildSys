...
$router->group(['prefix' => '/', 'middleware' => ['auth']], function () use ($router) {
    ...
    $router->group(['middleware' => 'needsPermission:quadroDeConcorrencias.list'], function () use ($router) {
        ...
        $router->get('quadro-de-concorrencia/{quadroDeConcorrencias}/remover-fornecedor/{fornecedorId}', ['as' => 'quadroDeConcorrencias.removerfornecedor', 'uses' => 'QuadroDeConcorrenciaController@removerFornecedor'])->middleware("needsPermission:quadroDeConcorrencias.edit");
