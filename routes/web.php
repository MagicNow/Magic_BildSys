...
$router->group(['prefix' => 'admin', 'middleware' => ['auth', 'needsPermission:dashboard.access']], function () use ($router) {
    ...
    Route::get('/get/mothers', 'PessoaController@getMothers');
    Route::get('/get/fathers', 'PessoaController@getFathers');
    Route::get('/phone/delete', 'PessoaController@deletePhone');
    Route::get('/bank_data/delete', 'PessoaController@deleteBankData');
    Route::get('/documentation/delete', 'PessoaController@deleteDocumentation');
    Route::get('/email/delete', 'PessoaController@deleteEmail');
    Route::get('/address/delete', 'PessoaController@deleteAddress');
