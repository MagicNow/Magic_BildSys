!function (e) {
    ...
    "use strict";
    var o = {}, a = document.querySelector(".app__snackbar"), i = null;
    o.show = function (e) {
    ...
    a.active = !1, a.webcam = null, a.canvas = null, a.ctx = null, a.decoder = null, a.setCanvas = function () {
        ...
        window.iOS ? a.webcam = document.querySelector("img") : a.webcam = document.querySelector("video"), a.setCanvas(), a.decoder = new Worker("/qrcodelib/decoder.min.js"), window.iOS ? e() : a.webcam.addEventListener("play", function (t) {
            ...
            if (n.length > 1) {
                var o = {video: {mandatory: {sourceId: n[1].deviceId ? n[1].deviceId : null}}, audio: !1};
                t(o)
            } else if (n.length) {
                var o = {video: {mandatory: {sourceId: n[0].deviceId ? n[0].deviceId : null}}, audio: !1};
                t(o)
            } else t({video: !0})
        }).catch(function (e) {
    ...
    var a = n(1), i = o(a), c = n(0), r = n(2), l = (o(r), n(3)), d = o(l);
    "serviceWorker" in navigator && navigator.serviceWorker.ready.then(function (e) {
        ...
        var r = null, l = null, s = document.querySelector(".app__select-photos"), u = document.querySelector(".app__dialog"), p = document.querySelector(".app__dialog-overlay"), v = document.querySelector(".app__dialog-open"), f = document.querySelector(".app__dialog-close"), m = document.querySelector(".custom-scanner"), y = document.querySelector("#result"), w = document.querySelector(".app__help-text"), g = document.querySelector(".app__header-icon svg"), h = document.querySelector("video");
