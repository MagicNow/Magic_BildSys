<div class="form-group col-sm-6">
    ...
    <p class="form-control">{!! $qc->tipologia()->withTrashed()->first() ? $qc->tipologia()->withTrashed()->first()->nome : null !!}</p>
</div>

<!-- Carteira Field -->
<div class="form-group col-sm-6">
    {!! Form::label('carteira_id', 'Carteira') !!}
    <p class="form-control">{!! $qc->carteira()->withTrashed()->first() ? $qc->carteira()->withTrashed()->first()->nome : NULL !!}</p>
</div>

<!-- Pbta Field -->
<div class="form-group col-sm-6">
    {!! Form::label('obra_id', 'Obra') !!}
    <p class="form-control">{!! $qc->obra()->withTrashed()->first() ? $qc->obra()->withTrashed()->first()->nome : NULL !!}</p>
</div>
