...
@section('content')
    <div class="content-header">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    Papéis
                                    <button data-toggle="modal" data-target='#role-modal-{{ $user->id }}'
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    ...
                                    <button data-toggle="modal" data-target='#permission-modal-{{ $user->id }}'
                                            class="btn btn-success btn-xs pull-right">
                                        <span class="glyphicon glyphicon-plus"></span>
                                    ...
                                    @foreach ($user->permissions as $permission)
                                        ...
                                        <div class="btn-group">
                                            ...
                                            @if($permission->pivot->value == 1)
                                                <a href="{{ url('admin/manage/permissions/' . $permission->id . '/edit') }}}}"
                                                   class="btn btn-info btn-xs">
        ...
        <div class="modal fade" id="role-modal-{{ $user->id }}" tabindex="-1" role="dialog"
             aria-labelledby="roleFormLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="permission-modal-{{ $user->id }}" tabindex="-1" role="dialog"
             aria-labelledby="permissionFormLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
