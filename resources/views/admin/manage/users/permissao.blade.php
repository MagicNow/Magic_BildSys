    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="roleFormLabel">Adicionar Perfil</h4>
            </div>
            <div class="modal-body">
                <div class="alert alert-info">
                    Selecione o Perfil que deseja adicionar.
                </div>
                ...
                {{ Form::submit('Adicionar Perfil', ['class' => 'btn btn-primary', 'id' => 'role-save-button']) }}
