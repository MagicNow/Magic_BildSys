...
@section('scripts')
    ...
    <script>
		...
		//Carregar Tabelas
		function carregarTabelas(a, b ,c){
			
			//chama a view de graficos			
			startLoading();	            
			
            $.ajax('/admin/cronogramaFisicos/semanal-tabelas', {
                data: {
                    obra_id: a,
					mes_id: b,
					semana_id: c
			...
			carregarDadosGraficos(a,b,c);
        
			stopLoading();
		}
		
		//Carregar Dados do Gráfico
		function carregarDadosGraficos(a, b ,c){
			
			$.ajax('/admin/cronogramaFisicos/semanal-graficos', {
                data: {
                    obra_id: a,
					mes_id: b,
					semana_id: c
		...
		function carregarGraficos(data){						
			...
			loadVue(GraficoPrevistoRealizadoLabels, GraficoPrevistoRealizadoPrevistoSem, GraficoPrevistoRealizadoRealizadoSem,GraficoPDPTrabRealAcumSemLabels, GraficoPDPTrabRealAcumSem, GraficoPDPTrabRealAcumSemPDP, GraficoPDPTrabRealAcumSemTrab, GraficoPDPTrabRealAcumSemReal, GraficoTarefasCriticasLabels, GraficoTarefasCriticasPrevistoAcum, GraficoTarefasCriticasRealizadoAcum)			
		}
